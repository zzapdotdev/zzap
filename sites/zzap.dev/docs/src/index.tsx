        ...
        <header>
          ...
          >
            <ul>
              <li>
                <a href="/">
                  <ZzapIcon className="tw-w-[8rem] tw-pt-2  tw-text-black dark:tw-text-white"></ZzapIcon>
                </a>
              </li>
            </ul>
            <ul>
            ...
            <g transform="matrix(3.51845 0 0 10.4456 -1853.01 -13118.9)">
              <g>
                <g>
                  ...
                  <path
                    fillRule="nonzero"
                    d="M1232.52 1495.19c-73.75 0-110.63-36.54-110.63-120.74 0-43.1 13.31-74.84 39.91-95.21 26.6-20.38 61.12-30.57 103.56-30.57 34.68 0 63.31 10.36 85.87 31.07 22.56 20.71 33.51 47.9 32.84 81.58l-3.41 133.87h-84.36l-2.66-26.78c-6.73 9.43-15.66 11.62-26.77 17.68-11.11 6.06-22.56 9.1-34.35 9.1zm15.16-120.74c-15.16 0-22.74 7.58-22.74 22.74 0 15.15 7.58 22.73 22.74 22.73 6.73 0 12.2-1.94 16.41-5.81 4.21-3.87 6.32-9.51 6.32-16.92 0-7.07-2.19-12.63-6.57-16.67-4.38-4.04-9.77-6.07-16.16-6.07z"
                    transform="translate(0 37.128)"
                  ></path>
                  <path
                    fillRule="nonzero"
                    d="M1408.82 1570.45l-4.55-183.37 2.83-139.42h84.36l3.23 32.33c15.49-21.55 38.23-32.33 68.2-32.33 33.68 0 59.52 10.19 77.54 30.56 18.01 20.38 26.69 50.6 26.01 90.68 0 43.44-7.91 76.19-23.74 98.25-15.83 22.06-42.26 27.02-79.31 27.02-24.24 0-44.45-.67-60.61-14.14l-2.53 90.42h-91.43zm108.1-173.26c0 7.41 2.19 13.13 6.57 17.17 4.37 4.04 9.93 6.06 16.67 6.06 15.15 0 22.73-7.74 22.73-23.23 0-14.48-7.58-21.73-22.73-21.73-6.74 0-12.3 1.94-16.67 5.82-4.38 3.87-6.57 9.17-6.57 15.91z"
                    transform="translate(-2.96) translate(0 38.139)"
                  ></path>
                  <circle
                    cx="17425.9"
                    cy="1972.05"
                    r="136.907"
                    transform="translate(-2.96) matrix(.33496 0 0 .33496 -4301.54 766.094)"
                  ></circle>
                  <g transform="matrix(.33496 0 0 .33496 -4583.93 769.444)">
                    <circle cx="17425.9" cy="1972.05" r="136.907"></circle>
                  </g>
                </g>
              </g>
            </g>
